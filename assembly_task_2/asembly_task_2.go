...
func getKafkaOptions() []configuration.KafkaOptionFunc {
	...
	kafkaOptions = append(kafkaOptions, configuration.WithKafkaTopic(enums.AssemblyTask2.String()))
	kafkaOptions = append(kafkaOptions, configuration.WithKafkaGroupId(enums.AssemblyTask2.String()))
