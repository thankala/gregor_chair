...
func (a *AssemblyTask4Actor) Steps() interfaces.StepHandlers[AssemblyTask4Actor] {
	return interfaces.StepHandlers[AssemblyTask4Actor]{
		...
		enums.Step2: a.processStep2GetSeatAndPlaceW2F1,
		enums.Step3: a.processStep3GetSeatPlate,
		enums.Step4: a.processStep4AttachW2F1,
	}
}

func (a *AssemblyTask4Actor) processStep1RequestFixture(event *events.AssemblyTaskEvent, ctx *actor.Context) {
...
func (a *AssemblyTask4Actor) processStep2GetSeatAndPlaceW2F1(event *events.AssemblyTaskEvent, ctx *actor.Context) {
...
func (a *AssemblyTask4Actor) processStep3GetSeatPlate(event *events.AssemblyTaskEvent, ctx *actor.Context) {
...
func (a *AssemblyTask4Actor) processStep4AttachW2F1(event *events.AssemblyTaskEvent, ctx *actor.Context) {
	a.robot.ValidateCurrentTask(event.Destination)
